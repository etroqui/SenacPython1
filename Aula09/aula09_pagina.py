...
def getProximaURL(p_soup, p_ultima_pagina):
    ...
    while d_contador <= p_ultima_pagina:
        d_url = "https://www.superpaguemenos.com.br/hortifruti/?p=" + str(d_contador)
        v_dados = ConsultaSitePagueMenos(d_url)
        GravarArquivoXLSX(v_dados,'ProdutosPagueMenos',d_contador)        
        d_contador += 1
